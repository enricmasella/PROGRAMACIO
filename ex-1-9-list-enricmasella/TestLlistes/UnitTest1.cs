...
namespace TestLlistes
{
    public class TestsMetodesLlistes
    {
        ...
        {
            Assert.Equal(new List<int> { 1, 2, 3 }, MetodesLlistes.OmpleNaturals(3));
        ...
        public void Test_GeneraLlista()
        {
            ...
            Assert.Equal(new List<int> {-14, -8, -89, -4, -46, -15 }, llista);
            Assert.Equal(new List<int> { 73, 16, 93 }, MetodesLlistes.GeneraLlista(3,6));
            Assert.Empty(MetodesLlistes.GeneraLlista(0,6));
            Assert.Equal(new List<int> { 73 }, MetodesLlistes.GeneraLlista(1, 6));
        }
        ...
        public void Test_CapgiraLlista()
        {
            ...
            Assert.Equal(new List<int> {5, 4, 3, 2, 1 }, llista);
            List<int> llista2 = new List<int> { 1, 2, 3, 4, 5 };
            MetodesLlistes.CapgiraLlista(llista2);
            Assert.Equal(new List<int> { 5, 4, 3, 2, 1 }, llista2);
        }
